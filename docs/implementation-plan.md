...
- Validate only OpenD reachability, SDK/API version, account-list shape, US market capability, market-data entitlement metadata, and paper-account availability.
