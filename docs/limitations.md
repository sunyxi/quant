...
- The Shadow Mode run summary reader and writer handle local JSON files for fixture review only; they do not upload reports, manage retention, or trigger operational state changes.
