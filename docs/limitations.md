...
- The localhost policy rejects encoded endpoint paths and reapplies loopback and read-only checks to redirects. These controls are validated with local fake openers and still require Windows runtime validation against kabu Station.
