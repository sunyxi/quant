...
- The kabu Station mapper and official request contract helpers are local-only and do not authenticate, send HTTP requests, cancel orders, query order status, or place live orders.
