...
- The Shadow Mode run summary writer can create local JSON files for fixture review only; it does not upload reports, manage retention, or trigger operational state changes.
