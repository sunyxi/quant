...
These tests evaluate local replay result fixtures, run summaries, summary review aggregation, summary schema versioning, and local summary JSON read/write behavior only. They do not connect to market data, connect to brokers, submit orders, or cancel orders.
